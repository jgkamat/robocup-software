...
static const note_t *const test_songs[] = {song_startup, song_failure, song_overvoltage, song_undervoltage, song_fuse_blown, song_victory, song_still_alive, song_ksp_theme};
